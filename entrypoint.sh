...
UUID=${UUID:-'07ddad10-e6e9-43ad-aa54-41126cd014d1'}
VMESS_WSPATH=${VMESS_WSPATH:-'/07ddad10-e6e9-43ad-aa54-41126cd014d1'}
VLESS_WSPATH=${VLESS_WSPATH:-'/07ddad10-e6e9-43ad-aa54-41126cd014d1'}
